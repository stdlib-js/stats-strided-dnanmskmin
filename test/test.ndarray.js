...
var dnanmskmin = require( './../lib/ndarray.js' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof dnanmskmin, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 7', function test( t ) {
	t.strictEqual( dnanmskmin.length, 7, 'has expected arity' );
	t.end();
});
...
tape( 'the function calculates the minimum value of a strided array according to a mask, ignoring NaN values', function test( t ) {
	...
	v = dnanmskmin( x.length, x, 1, 0, mask, 1, 0 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', function test( t ) {
	...
	v = dnanmskmin( 0, x, 1, 0, mask, 1, 0 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );

	v = dnanmskmin( -1, x, 1, 0, mask, 1, 0 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );
...
tape( 'the function supports negative `stride` parameters', function test( t ) {
	...
	v = dnanmskmin( 6, x, -2, 10, mask, -2, 10 );
